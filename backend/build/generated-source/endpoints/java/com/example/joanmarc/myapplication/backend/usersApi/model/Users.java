...
public final class Users extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Users> friends;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Users> getFriends() {
    return friends;
  }
   ...
   */
  public Users setFriends(java.util.List<Users> friends) {
   ...
   */
  public Users setRoutes(java.util.List<Route> routes) {
    this.routes = routes;
    return this;
  }
