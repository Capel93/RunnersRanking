...
public final class Route extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<java.util.List<java.lang.Double>> route;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<java.util.List<java.lang.Double>> getRoute() {
    return route;
  }
   ...
   */
  public Route setRoute(java.util.List<java.util.List<java.lang.Double>> route) {
    this.route = route;
    return this;
  }
   ...
   */
  public Route setTime(Time time) {
    this.time = time;
    return this;
  }
